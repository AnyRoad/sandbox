...
import org.springframework.web.servlet.config.DispatcherServletRegistrationBean;
 ...
 * {@link TransmittableDispatcherServlet}. Should work for a standalone application where an embedded
...
@ConditionalOnClass(TransmittableDispatcherServlet.class)
@AutoConfigureAfter(ServletWebServerFactoryAutoConfiguration.class)
public class TransmittableDispatcherServletAutoConfiguration {
    ...
    protected static class DispatcherServletConfiguration {
        ...
        public TransmittableDispatcherServlet dispatcherServlet(WebMvcProperties webMvcProperties, Environment environment) {
            TransmittableDispatcherServlet dispatcherServlet = new TransmittableDispatcherServlet();
        ...
        @ConditionalOnMissingBean(name = TransmittableDispatcherServlet.MULTIPART_RESOLVER_BEAN_NAME)
    ...
    protected static class DispatcherServletRegistrationConfiguration {
        ...
        @ConditionalOnBean(value = TransmittableDispatcherServlet.class, name = DEFAULT_DISPATCHER_SERVLET_BEAN_NAME)
        public DispatcherServletRegistrationBean dispatcherServletRegistration(TransmittableDispatcherServlet dispatcherServlet,
    ...
    private static class DefaultDispatcherServletCondition extends SpringBootCondition {
        ...
        public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata metadata) {
            ...
            List<String> dispatchServletBeans = Arrays
                    .asList(beanFactory.getBeanNamesForType(TransmittableDispatcherServlet.class, false, false));
