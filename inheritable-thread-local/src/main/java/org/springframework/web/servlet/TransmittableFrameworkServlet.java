...
import org.springframework.web.servlet.context.transmittable.LocaleContextHolder;
 ...
 * {@link #TransmittableFrameworkServlet(WebApplicationContext)} Javadoc for details.
 *
 * @author Rod Johnson
...
public abstract class TransmittableFrameworkServlet extends HttpServletBean implements ApplicationContextAware {
	 ...
	 */
	public static final String SERVLET_CONTEXT_PREFIX = TransmittableFrameworkServlet.class.getName() + ".CONTEXT.";
	 ...
	 *
	 * @see #TransmittableFrameworkServlet(WebApplicationContext)
	 */
	public TransmittableFrameworkServlet() {
	}
	 ...
	 */
	public TransmittableFrameworkServlet(WebApplicationContext webApplicationContext) {
	...
	protected final void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		asyncManager.registerCallableInterceptor(TransmittableFrameworkServlet.class.getName(), new RequestBindingInterceptor());
	...
	private class ContextRefreshListener implements ApplicationListener<ContextRefreshedEvent> {
		...
		@Override
		public void onApplicationEvent(ContextRefreshedEvent event) {
			TransmittableFrameworkServlet.this.onApplicationEvent(event);
		}
	}
