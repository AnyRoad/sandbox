 ...
 * @since 2.0.4
 */
public class DispatcherServletRegistrationBean extends ServletRegistrationBean<TransmittableDispatcherServlet>
     ...
     */
    public DispatcherServletRegistrationBean(TransmittableDispatcherServlet servlet, String path) {
        super(servlet);
